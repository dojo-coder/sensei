Create an Image Slider component in Angular.

The component will receive an array of image URLs as input "images".

There should be one img tag that changes its source.

There should also be two buttons under the image: Previous and Next. On click of the buttons the img source will change, loading the next or previous image from the list of images input.
